...
TweenLite.to(stroke,0,{drawSVG:'100% 100%'});
  ...
  function animateSection(expandSection, expandBtn, expandHeight, state){
    ...
    // open
    if (state === 'open'){
    expandSection.velocity({ height:expandHeight opacity: 1, marginTop:24},{ duration:500,
    ...
    // close  
      ...
      expandSection.velocity({height:0, opacity: 0, marginTop:0},{duration:500,
        begin: function(){
